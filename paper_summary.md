...
Actualizado: 2026-08-20 23:55:50 (hora de Perú)
...
**Capital comprometido ahora mismo:** $115.00 en 23 posiciones abiertas (disponible para nuevas apuestas: $333.59)
...
- **Apuestas resueltas:** 707
- **Aciertos:** 452 (63.9%)
- **Cuota promedio de entrada:** 63.6%
- **Stake promedio:** $4.99
- **Total apostado (suma de stakes):** $3,530.45
- **ROI sobre lo apostado:** -2.09%
- **Comisiones pagadas (taker fee):** $64.30 (1.82% del capital apostado)
...
|---|---|---|---|---|---|---|---|
| ferrariChampions2026 | Dota 2: Iron Wing vs BoomBoys (BO3) - Th | BoomBoys (BUY) | 55% | 5.00 | 2.0% | ⏳ pendiente | — |
